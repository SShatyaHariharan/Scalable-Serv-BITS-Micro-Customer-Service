...
create table app_user (id bigint not null, address varchar(255), contact_number varchar(255), email varchar(255), name varchar(255), status BOOLEAN DEFAULT 1, primary key (id));

INSERT INTO app_user (address, contact_number, email, name, id, status) 
VALUES 
('Talab Tillo Jammu', '223333', 'rajt@gmail.com', 'Rajat', 9991, TRUE),
('Talab Tillo Jammu, J&K', '9923232', 'ViveRock@gmail.com', 'Vivek', 9992, TRUE),
('NIBM Pune', '233342234', 'mike@gmail.com', 'Mike', 9993, TRUE);
